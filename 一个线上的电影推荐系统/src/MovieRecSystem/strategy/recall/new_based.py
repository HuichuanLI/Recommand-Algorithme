...
class NewBasedRecall(object):
    def __init__(self):
        self.REDIS_KEY = "rec:new_spu"
    ...
    def _get_new_items(self) -> List[RecItem]:
        """
        提取热销商品列表
        :return:
        """
        ...
        result: List[RecItem] = []
        for _id in spu_ids:
            result.append(RecItem.get_recall_rec_item(_id, 1.0, "news", "news"))
        return result
