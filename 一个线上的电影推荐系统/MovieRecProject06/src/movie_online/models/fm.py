...
def fetch_fm_spu_base_features(spu: SpuFeatureEntity) -> pd.DataFrame:
    ...
    data.update(movie_mean_rating)
    data.update(movie_user_gender_mean_rating)
...
class FMUserSideLocalPredictor(BasePredictor):
    ...
    def __init__(self, model_dir, model_version):
        print("FMUserSideLocalPredictor")
        print(model_dir)
        # model_dir = '/Users/lhc456/Desktop/python/Recommand-Algorithme/Recommand-Algorithme/一个线上的电影推荐系统/MovieRecProject06/test/tmp/fm/'
