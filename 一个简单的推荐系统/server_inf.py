...
class RecallServer:
    def __init__(self):
        ...
        self.user_feature_pool = \
            redis.from_url('redis://127.0.0.1:6379/1')

        self.item_feature_pool = \
            redis.from_url('redis://127.0.0.1:6379/2')

        self.matrixcf_i2i_pool = \
            redis.from_url('redis://127.0.0.1:6379/3')

        self.itemcf_i2i_pool = \
            redis.from_url('redis://127.0.0.1:6379/4')

        self.usercf_u2u_pool = \
            redis.from_url('redis://127.0.0.1:6379/5')

        self.fm_i2i_pool = \
            redis.from_url('redis://127.0.0.1:6379/6')

        self.fm_item_embedding_pool = \
            redis.from_url('redis://127.0.0.1:6379/7')

        self.fm_user_feature_embedding_pool = \
            redis.from_url('redis://127.0.0.1:6379/8')
