...
import os
from base_layer import FMLayer
...
class FM(object):
    ...
    def init_model(self):
        ...
        result = FMLayer(self.user_feature_name, self.item_feature_name,
                         self.feature_size, self.embedding_size)(input_dic)
        self.model = tf.keras.Model(input_dic, result)
        self.model.summary()
