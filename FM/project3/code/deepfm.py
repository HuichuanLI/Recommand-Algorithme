...
import os
from base_layer import FMLayer, MLPLayer
...
class DEEPFM(object):
    ...
    def __init__(self):
        ...
        self.lr = 0.01
        self.checkpoint_dir = "../model/deepfm"
    ...
    def init_model(self):
        ...
        _fm_out = FMLayer()(emb_list, w_list)
        _deep_out = tf.keras.layers.Flatten()(emb_list)
        _deep_out = MLPLayer(units=[64, 8], activation='relu')(_deep_out)
        _out = tf.concat([_fm_out, _deep_out], axis=1)
