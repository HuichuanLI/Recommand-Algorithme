...
class AFM_layer(Layer):
    def __init__(self, feature_columns, mode):
        ...
        self.mode = mode
        # self.e1 = Embedding(1000, 128)(inputs[0])
        # self.e2 = Embedding(1000, 128)(inputs[1])
    ...
    def call(self, inputs, **kwargs):
        ...
        dense_inputs, sparse_inputs = inputs[:, :13], inputs[:, 13:] # 13是稀疏特征和dense特征的分界线
        ...
        embed = tf.transpose(embed, [1, 0, 2])  #[None, 13，k]
